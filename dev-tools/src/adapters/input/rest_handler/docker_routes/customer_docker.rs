...
#[get("/customers/actions/fetch/logs/tail?<container_type>&<number_of_lines>")]
pub fn customers_logs(
...
#[post(
    "/customers/actions/restart",
    format = "application/json",
    data = "<restart_request>"
)]
pub async fn restart_customers_container(
    user: AuthenticatedUser,
    docker: &State<DynDockerPort>,
