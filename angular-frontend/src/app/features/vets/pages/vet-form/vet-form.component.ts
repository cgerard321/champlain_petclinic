            ...
            <form (ngSubmit)="submitVetForm(vet)">
              <div class="row g-3">
                ...
                <div class="parent">
                  ...
                  <img
                    alt=""
                    [src]="previewImage ? 'data:image/jpeg;base64,' + previewImage : null"
                    *ngIf="previewImage"
                    width="150"
                    height="150"
                    class="image2"
                ...
                <div id="user-info" *ngIf="!isEdit">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      required
                    />
                    <span *ngIf="!vet.username || vet.username === ''" class="help-block"
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      required
                    />
                    <span *ngIf="!vet.password || vet.password === ''" class="help-block"
...
export class VetFormComponent implements OnInit {
  ...
  submitVetForm(vet: Record<string, unknown>): void {
  ...
  uploadPhoto(vetId: string): void {
    ...
    reader.onloadend = () => {
      const vetPhoto = (reader.result as string).replace('data:', '').replace(/^.+,/, '');
