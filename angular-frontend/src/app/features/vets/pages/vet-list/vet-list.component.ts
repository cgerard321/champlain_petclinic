    ...
    <div>
      ...
      <form onsubmit="void(0)" style="max-width: 20em; margin-top: 2em;">
        <div class="form-group">
          <input class="form-control" [(ngModel)]="query" name="query" placeholder="Search" type="text"/>
        </div>
      </form>

      <div style="margin-bottom: 1%; margin-top: 1%">
        <label for="filterOption">Filter</label>
        <select id="filterOption" [(ngModel)]="selectedFilter" (change)="reloadData()" name="filter">
...
export class VetListComponent implements OnInit {
  ...
  getTopThreeVetsWithHighestRating(_vet: Vet): void {
  }
