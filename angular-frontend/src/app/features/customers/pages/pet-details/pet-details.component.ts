        ...
        <div class="content-wrapper">
          ...
          <div *ngIf="pet" class="details-card">
            <div class="card-header">
              ...
              <div
                class="status-badge"
                [class.status-active]="pet.isActive"
                [class.status-inactive]="!pet.isActive"
              >
            ...
            <form class="pet-form">
              <div class="form-grid">
                ...
                <div class="form-group">
                  <input
                    class="form-input"
                    [value]="getBirthday(pet.birthDate)"
                    readonly
                    disabled
                  />
                ...
                <div class="form-group">
                  <input
                    class="form-input"
                    [value]="getPetTypeName(pet.petTypeId)"
                    readonly
                    disabled
                  />
            ...
            <div class="action-buttons">
              <a
                class="btn-submit"
                [routerLink]="['/owners', pet.ownerId, 'pets', pet.petId, 'edit']"
              >
                &#x270F; Edit Pet
              </a>
              <button
                class="btn-modern btn-status"
            ...
            <div class="info-card">
              <p class="info-text">
                Use the buttons above to manage this pet's status and information
              </p>
            </div>
          </div>
        </div>
