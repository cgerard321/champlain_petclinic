      ...
      <div class="main-content">
        <div class="page-header">
          ...
          <p class="page-subtitle">
            {{ isEditMode ? 'Update pet information' : 'Register a new pet' }}
          </p>
        </div>
                ...
                <div class="form-grid">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      [disabled]="checked"
                    />
                    <span *ngIf="petForm.name?.$error?.required" class="error-message"
...
export class PetFormComponent implements OnInit {
  ...
  submit(): void {
    ...
    if (
      confirm(
        'Are you sure you want to submit this form with the following details?\n\n' +
          'Pet Name: ' +
          this.pet.name +
          '\n' +
          'Pet Birth Date: ' +
