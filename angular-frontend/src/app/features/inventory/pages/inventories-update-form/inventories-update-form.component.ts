...
@Component({
  ...
  template: `
    <div class="bColor text-center">
      <h2 class="titleBundle form" id="title">Update Inventory</h2>
    </div>
      ...
      <div id="inventoryUpdateForm" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="col-sm-6 form-group">
          ...
          <input
            ...
            type="text"
            placeholder="Search"
            [(ngModel)]="inventoryTypeFormUpdateSearch"
            (ngModelChange)="updateOptionUpdate()"
          />
          <select
            class="form-control col-sm-4"
            id="inventoryType"
          ...
          >
            <option *ngFor="let option of inventoryTypeUpdateOptions" [value]="option">
              {{ option }}
            </option>
          </select>
        </div>
        ...
        <div class="form-group p-3">
          <div class="bundle marg col-sm-12">
            <button
              ...
              type="button"
              (click)="submitUpdateInventoryForm()"
            >
              Submit
            </button>
          </div>
