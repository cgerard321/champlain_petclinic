...
var EXISTING_FILE_INFO = domain.FileInfo{
	FileId:   "3e5a214b-009d-4a25-9313-344676e6157d",
	FileName: "test image",
	FileType: "image/jpeg",
}

var NON_EXISTING_FILE_INFO = domain.FileInfo{
...
var EXISTING_FILE_RESPONSE_MODEL = model.FileResponseModel{
	FileId:   "3e5a214b-009d-4a25-9313-344676e6157d",
	FileName: "test image",
	FileType: "image/jpeg",
...
func TestMain(m *testing.M) {
	...
	var err error
	minioContainer, err := container.Run(ctx, "cgr.dev/chainguard/minio@sha256:bd014394a80898e68c149f2311fdf8d5a2c2f3bb2c33b9327ae6d02b4b065ae1", container.WithUsername("user"), container.WithPassword("password"))
	if err != nil {
