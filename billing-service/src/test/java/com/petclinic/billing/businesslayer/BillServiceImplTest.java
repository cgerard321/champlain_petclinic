...
public class BillServiceImplTest {
    ...
    private Bill buildBill(){
        ...
        return Bill.builder().id("Id").billId("BillUUID").customerId(1).vetBillId("1").visitType("Test Type").visitDate(date).amount(13.37).build();
    }
    ...
    private BillDTO buildBillDTO(){
        ...
        return BillDTO.builder().billId("BillUUID").customerId(1).vetBillId("1").visitType("Test Type").date(date).amount(13.37).build();
    }
