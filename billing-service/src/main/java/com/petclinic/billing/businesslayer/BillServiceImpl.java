...
public class BillServiceImpl implements BillService {
    ...
    // @Override
    // public Flux<BillResponseDTO> getAllBillsByPage(Pageable pageable, String
    // billId, String customerId,
    ...
    //
    //
    // if(billId == null && customerId == null && ownerFirstName == null &&
    // ownerLastName == null && visitType == null
                ...
                .flatMap(bill -> {
                    if (bill.getBillStatus() == BillStatus.UNPAID || bill.getBillStatus() == BillStatus.OVERDUE) {
                        return Mono.error(new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY,
                                "Cannot delete a bill that is unpaid or overdue."));
                    }
