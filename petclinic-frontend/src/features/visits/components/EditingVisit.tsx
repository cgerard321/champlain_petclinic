...
const EditingVisit = forwardRef<EditingVisitHandle, EditingVisitProps>(
  ({ showButton, visitId }, ref): JSX.Element => {
    ...
    // expose imperative methods for parent rows to open the modals
...
EditingVisit.displayName = 'EditingVisit';
