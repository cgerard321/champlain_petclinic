          ...
          {ratings && ratings.length > 0 ? (
              ratings.map((rating, index) => (
                  <div key={index} className="rating-card">
                    ...
                    <p><strong>Rating:</strong> {rating.rateScore} / 5</p>
                    <p><strong>Experience:</strong> {rating.predefinedDescription}</p>
                    <p><strong>Description:</strong> {rating.rateDescription}</p>
                    <p><strong>Rate Date:</strong> {rating.rateDate || "No date available"}</p>
                    <hr />
                  </div>
              ))
          ) : (
