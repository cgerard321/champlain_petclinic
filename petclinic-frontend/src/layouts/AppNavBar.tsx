          ...
          <Nav className="me-auto">
            ...
            {user.userId && (
              <>
                ...
                {isOwner && !isAdmin && !isVet && !isReceptionist && (
                  <NavDropdown title="Visits" id="owner-visits-dropdown">
                  <NavDropdown.Item as={Link} to={AppRoutePaths.CustomerVisits}>
                    List View
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to={AppRoutePaths.CustomerVisitsCalendar}>
                      Calendar View
                    </NavDropdown.Item>
                  </NavDropdown>
                )}  
                ...
                {(isAdmin || isReceptionist) && (
                  <NavDropdown title="Visits" id="staff-visits-dropdown">
                    ...
                    <NavDropdown.Item as={Link} to={AppRoutePaths.VisitsCalendar}>
                      Calendar View
                    </NavDropdown.Item>
                  </NavDropdown>
                )}
