...
await expect(page.locator('div').filter({ hasText: /^Friday$/ }).getByRole('checkbox')).toBeVisible();
await page.locator('div').filter({ hasText: /^Friday$/ }).getByRole('checkbox').uncheck();
