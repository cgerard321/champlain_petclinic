package com.petclinic.inventoryservice.http;
...
public class BundleControllerExceptionHandler {
    private static final Logger LOG = LoggerFactory.getLogger(BundleControllerExceptionHandler.class);
