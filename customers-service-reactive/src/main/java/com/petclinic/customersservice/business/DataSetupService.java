...
public class DataSetupService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        PetType pt6 = new PetType("6","1103c9b8-4ffd-4866-a5ed-287117c60a89" ,"Hamster","Mammal");
         ...
         petTypeService.getAllPetTypes().hasElements().flatMap(hasElements -> {
            if(!hasElements) {
                return Flux.just(pt1, pt2, pt3, pt4, pt5, pt6)
       ...
       petService.getAllPets().hasElements().flatMap(hasElements -> {
            if(!hasElements) {
                return Flux.just(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13)
        ...
        ownerService.getAllOwners().hasElements().flatMap(hasElements -> {
            if(!hasElements) {
                return Flux.just(o1, o2, o3, o4, o5, o6, o7, o8, o9, o10)
        ...
        photoService.getAllPhotos().hasElements().flatMap(hasElements -> {
            if(!hasElements) {
                return Flux.just(ph1)
