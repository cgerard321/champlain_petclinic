...
public class DataSetupService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pet p4 = new Pet(4, 3, 2, "Jewel", new SimpleDateFormat( "yyyyMMdd" ).parse( "2000-03-07"), 1);
        Pet p5 = new Pet(5, 4, 3, "Iggy", new SimpleDateFormat( "yyyyMMdd" ).parse( "2000-11-30"), 1);
        Pet p6 = new Pet(6, 5, 6, "George", new SimpleDateFormat( "yyyyMMdd" ).parse( "2000-11-30"), 1);
        Pet p7 = new Pet(7, 6, 1, "Samantha", new SimpleDateFormat( "yyyyMMdd" ).parse( "1995-09-04"), 1);
        Pet p8 = new Pet(8, 6, 1, "Max", new SimpleDateFormat( "yyyyMMdd" ).parse( "1995-09-04"), 1);
        Pet p9 = new Pet(9, 7, 5, "Lucky", new SimpleDateFormat( "yyyyMMdd" ).parse( "1999-08-06"), 1);
        Pet p10 = new Pet(10, 8, 2, "Mulligan", new SimpleDateFormat( "yyyyMMdd" ).parse( "1997-02-24"), 1);
