...
public interface PhotoService {
    ...
    Mono<Resource> insertPhotoOfVet(String vetId, String photoName, MultipartFile file);
    Mono<Resource> insertPhotoOfVet(String vetId, String photoName, byte[] fileData);
