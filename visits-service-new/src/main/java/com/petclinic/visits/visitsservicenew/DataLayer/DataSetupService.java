...
public class DataSetupService implements CommandLineRunner {
    ...
    private void setupReviews() {
        ...
        private Visit buildVisit (String visitId, String visitStartDate, String description, String petId, String
        practitionerId, Status status, LocalDateTime visitEndDate){
