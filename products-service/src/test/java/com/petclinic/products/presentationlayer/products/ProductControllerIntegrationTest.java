...
class ProductControllerIntegrationTest {
    ...
    public void setupDB() {
        ...
        productTypeRepository.deleteAll().block();
    ...
    @Test
    public void whenGetAllProducts_AndFilterByProductTypeId_thenReturnFilteredProducts() {
        productRepository.deleteAll().block();
        ratingRepository.deleteAll().block();
        imageRepository.deleteAll().block();
        ...
        productRepository.saveAll(List.of(product1, product2, product3)).blockLast();
    ...
    public void whenGetAllProductTypes_thenReturnAllProductTypes() {
        ProductType productType1 = ProductType.builder()
                ...
                .typeName("Product Type 1")
                .build();

        ProductType productType2 = ProductType.builder()
                .typeId(UUID.randomUUID().toString())
                .typeName("Product Type 2")
                .build();

        productTypeRepository.saveAll(List.of(productType1, productType2)).blockLast();

        webTestClient.get()
                .uri("/api/v1/products/types")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON)
                .expectBodyList(ProductTypeResponseModel.class)
                .value(productTypeResponseModels -> {
                    assertNotNull(productTypeResponseModels);
                    assertEquals(2, productTypeResponseModels.size());
                });
    }

    @Test
    public void whenGetAllProductTypes_AndNoProductTypesExist_thenReturnEmptyList() {
        // Arrange
        productTypeRepository.deleteAll().block();
        ...
        webTestClient.get()
                ...
                .value(productTypeResponseModels -> {
                    assertNotNull(productTypeResponseModels);
                    assertEquals(0, productTypeResponseModels.size());
                });
    }

    @Test
    public void whenAddProductType_thenReturnProductType() {
        ProductTypeRequestModel requestModel = ProductTypeRequestModel.builder()
                .typeName("Product Type 3")
                .build();
        ...
        webTestClient
                ...
                .uri("/api/v1/products/types")
                .contentType(MediaType.APPLICATION_JSON)
                .body(Mono.just(requestModel), ProductTypeRequestModel.class)
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isCreated()
                .expectHeader().contentType(MediaType.APPLICATION_JSON)
                .expectBody(ProductTypeResponseModel.class)
                .value(productTypeResponseModel -> {
                    assertNotNull(productTypeResponseModel);
                    assertNotNull(productTypeResponseModel.getTypeId());
                    assertEquals(requestModel.getTypeName(), productTypeResponseModel.getTypeName());
                });
