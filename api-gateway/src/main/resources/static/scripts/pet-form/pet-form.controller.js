...
angular.module("petForm").controller("PetFormController", [
  ...
  "$q",
  "$scope",
  function ($http, $state, $stateParams, $filter, $q, $scope) {
    var self = this;
    ...
    self.getPetTypeName = function (petTypeId) {
      switch (petTypeId) {
        case "4283c9b8-4ffd-4866-a5ed-287117c60a40":
          return "Cat";
        case "1233c9b8-4ffd-4866-4h36-287117c60a35":
          return "Dog";
        case "9783c9b8-4ffd-4866-a5ed-287117c60a10":
          return "Lizard";
        case "9133c9b8-4ffd-4866-a5ed-287117c60a19":
          return "Snake";
        case "2093c9b8-4ffd-4866-a5ed-287117c60a11":
          return "Bird";
        case "1103c9b8-4ffd-4866-a5ed-287117c60a89":
          return "Hamster";
        case "9993c9b8-4ffd-4866-a5ed-287117c60a99":
          return "Others";
        default:
          return "Unknown";
      }
