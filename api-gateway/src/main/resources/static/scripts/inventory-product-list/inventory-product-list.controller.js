  ...
  .controller("InventoryProductController", [
    ...
    function ($http, $scope, $stateParams, $window, InventoryService) {
      ...
      self.baseURLforTotalNumberOfProductsByFiltering =
        "api/gateway/inventory/" + $stateParams.inventoryId + "/products-count";
      self.lastParams = {
        productName: "",
        productQuantity: "",
        productPrice: "",
      ...
      $scope.deleteAllProducts = function () {
        ...
        if (varIsConf) {
          ...
          $http
            .delete("api/gateway/inventory/" + inventoryId + "/products")
            .then(
              function (response) {
      ...
      self.previousPage = function () {
        ...
        if (self.currentPage - 1 >= 0) {
          ...
          updateActualCurrentPageShown();
          console.log(
            "Called the previous page and the new current page " +
              self.currentPage,
          );
