...
//    @PostMapping(value = "{vetId}/photo/{photoName}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
//    }
    ...
    @SecuredEndpoint(allowedRoles = {Roles.ANONYMOUS})
    @GetMapping(value = "{vetId}/photo", produces = MediaType.APPLICATION_JSON_VALUE)
